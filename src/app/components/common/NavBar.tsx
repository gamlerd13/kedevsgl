...
function NavBar() {
  return (
    <NavigationMenu className="w-full text-xl font-medium h-20 bg-white fixed">
      <NavigationMenuList>
        <NavigationMenuItem>
            ...
            <ul className="grid grid-cols-4 gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3 col-span-1">
                <NavigationMenuLink asChild>
                  ...
                  >
                    <ImageComponent />
                    <div className="mb-2 mt-4 text-lg text-center">Kedevs</div>
                  </a>
                </NavigationMenuLink>
              </li>
              <ListItem href="/about" title="About us" className="col-span-2">
                Conoce más acerca de Kedevs
              </ListItem>
              <ListItem href="/team" title="Team" className="col-span-2">
                Nuestro Equipo
              </ListItem>
            </ul>
          </NavigationMenuContent>
